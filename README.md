# 🤖 AI 新闻聚合与生成平台# 🤖 AI 新闻聚合与生成平台# AI 新闻聚合与生成平台# AI 新闻聚合与生成平台
...
[![GitHub License](https://img.shields.io/badge/license-MIT-blue.svg)](LICENSE)> 一个完全免费的自动化 AI 新闻聚合、内容摘要和发布平台。使用 Next.js、Supabase 和免费 AI API 构建。

[![Node.js](https://img.shields.io/badge/node-%3E%3D18.0.0-green.svg)](https://nodejs.org/)

[![TypeScript](https://img.shields.io/badge/typescript-%3E%3D5.3.0-blue.svg)](https://www.typescriptlang.org/)

[![Next.js](https://img.shields.io/badge/next.js-%3E%3D14.0.0-black.svg)](https://nextjs.org/)
...
- 🔄 **自动采集** - 每天定时采集最新资讯（完全免费）[![TypeScript](https://img.shields.io/badge/typescript-%3E%3D5.3.0-blue.svg)](https://www.typescriptlang.org/)

- 📄 **文章管理** - 展示采集的文章，支持勾选和过滤

- 🤖 **AI 摘要** - 使用免费 AI 模型生成文章摘要

- 📊 **日报生成** - 生成精美的 HTML 日报

- 📤 **自动发布** - 发布到 GitHub Pages 或其他平台## ✨ 核心功能## 🎯 核心功能## 🎯 核心功能
